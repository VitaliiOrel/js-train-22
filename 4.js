...
class HoneyDecorator {
  ...
  get price() {
    ...
    return this.drink.price + honeyPrice * this.amount + " euro"
  }
...
console.log("FULL honeyTea: "); // Виводить нову назву напою
for (const [key, value] of Object.entries(honeyTea)) {
  console.log(`${key}:${value}`)
}
for (const [key, value] of Object.entries(honeyTea.drink)) {
  console.log(`${key}:${value}`)
}
console.log("------------------"); // Виводить нову назву напою
